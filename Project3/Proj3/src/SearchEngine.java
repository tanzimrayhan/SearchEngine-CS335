...
public class SearchEngine {
    ...
    static HashMap<String, WordDetails> invertedIndex = new HashMap<>();
    static String stopListText, invertedIndexText, corpusDir, queryFile, resultFile, snippetText;
    ...
    public static void main(String[] args) {
        ...
        if (snippetText == null) {
            ...
            // snips = q.getSnippets();
            // try {
            // WriteSnippets write = new WriteSnippets(snips, corpusDir, fixedNum,
            // snippetText);
    ...
    public static void GUIHelper(ArrayList<Snippet> snipsFromGui) {
        try {
            WriteSnippets write = new WriteSnippets(snipsFromGui, corpusDir, 25, snippetText);
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public HashMap<String, WordDetails> IndexSender() {

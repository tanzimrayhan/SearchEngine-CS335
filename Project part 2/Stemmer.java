...
//The algorithm is taken from https://tartarus.org/martin/PorterStemmer/java.txt. All credits are given to tartarus.
import java.io.*;
import java.util.ArrayList;

class Stemmer {
    static ArrayList<String> stemmedIndex = new ArrayList<>();
    private char[] b;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Stemming all the words of inverted index, please wait patiently...");
        for (int i = 0; i < args.length; i++)
            try {
                FileInputStream in = new FileInputStream(args[i]);
                FileWriter writer = new FileWriter("PorterInvertedIndex.txt");
                try {
                    while (true)
